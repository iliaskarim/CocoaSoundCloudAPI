...
#include "QuartzCore_GPKit.h"

void GP_CGContextAddRoundedRect(CGContextRef context,
                                       CGRect rect,
                                       CGFloat radius)
{
    CGMutablePathRef path = CGPathCreateMutable();
    GP_CGPathAddRoundedRect(path, nil, rect, radius);
    CGContextAddPath(context, path);
    CGPathRelease(path);
}


void GP_CGPathAddRoundedRect(CGMutablePathRef path,
